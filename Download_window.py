...
class download_window():
    ...
    def draw_Pics(self):
        ...
        self.photo1 = Image.open('Down-1.jpg')
        self.photo1s = self.photo1.resize( [int(.5 * s) for s in self.photo1.size] )
        preview1 = ImageTk.PhotoImage(self.photo1s)
        self.p1 = ttk.Label(self.appwindow,width = 20, image=preview1)
    ...
    def refresh_pics(self, count):
        ...
        pic1 = photos['data'][count]['source']
        urllib.urlretrieve(pic1, "Down-1.jpg")
